...
export default {
    ...
    methods: {
        savaLoanType() {
            ...
            axios.post('http://127.0.0.1:8000/api/loanType', LoanTypeData)
                .then(res => {
        ...
        handleSubmit() {
            if (this.name.length < 1) {
                this.nameError = 'Loan type is required';
                return;
            }
        }
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <div class="card-header mt-5">
                            <h4 class=" table_heading">Loan Type Add</h4>
                        </div>
                        <div class="card-body">
                            <form @submit.prevent="handleSubmit">
                                ...
                                <button type="submit" @click="savaLoanType" class="btn btn-primary">Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
